...
<body class="overflow-x-hidden  dark:bg-gray-900 dark:text-white">
    ...
    <?php
    include("sidebar.php");
    $query_select_all="SELECT Id_freelance, name_freelince, skills, mame FROM freelances INNER JOIN 
    user on freelances.id=user.id";
    $query = "SELECT id,mame FROM user";
                ...
                if (!$result_) {
                    ...
                    while ($row = mysqli_fetch_assoc($result_)) :
                        ...
                        <tr>
                            ...
                            <td><a href="modifer_free.php?IdFreelance=<?php echo $row['Id_freelance']; ?>"

                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class=" md:p-5 space-y-4">
                                <form action="">
                                    ...
                                    <div>
                                        <input type="name_cat" name="name_cat" id="name_cat"
                            ...
                            <div
                                ...
                                <input name="add_cat" value="add" type="submit"
                    ...
                    if(!$result) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><a href="modifier_cat.php?id_cat=<?php echo $row['id_cat']; ?>"
                                ...
                                <td><a href="supprimer_cat.php?id_cat=<?php echo $row['id_cat']; ?>"
